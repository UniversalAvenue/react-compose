...
exports.classNames = exports.children = exports.styles = exports.compose = exports.applyFunctor = exports.optimize = undefined;
...
var compose = exports.compose = function compose() {
  ...
  function mergeComposed(Component) {
    ...
    if (Component && Component.__composedBy) {
      var _Component$__composed = Component.__composedBy;
      var composers = _Component$__composed.composers;
      var Parent = _Component$__composed.Parent;

      ps = mergePropers(composers, optimizedPropers);
      Target = Parent;
    }
    var Result = compose(Target, ps);
    Result.__composedBy = {
